    ...
    Loc
        ...
        .exec((err, location) => {
            if (!location) {
                return res
                    .status(404)
                    .json({ "message": "location not found", "status": "2018250034 유찬영" });
            } else if (err) {
                return res
                    .status(400)
                    .json(err);
            ...
            if (location.reviews && location.reviews.length > 0) {
                ...
                if (!review) {
                    return res
                        .status(404)
                        .json({ "message": "review not found", "status": "2018250034 유찬영" });
                } else {

                    const response = {
                        location: {
                            "status": "2018250034 유찬영",
                ...
                return res
                    .status(404)
                    .json({ "message": "No reviews found", "status": "2018250034 유찬영" });
            }
        });
};
